...
class Rotate:
    ...
    def __call__(self, results):
        ...
        #print('max_r,otation is ',self.max_rotate_angle)
        angle_1 = level_to_value(random.randrange(1,10), self.max_rotate_angle)
        angle = random_negative(angle_1, self.random_negative_prob)
