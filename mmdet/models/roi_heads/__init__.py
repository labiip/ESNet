...
from .mask_heads import (CoarseMaskHead, FCNMaskHead, FeatureRelayHead,
                         ...
                         SCNetMaskHead, SCNetSemanticHead,myhead)
...
from .pa_standard_roi_head import PANetRoIHead
from .my_mff_roi_head import MyMFFRoIHead
from .new_roi_head import ESRoIHead
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead','myhead','MyRoIHead','PANetRoIHead','PABaseRoIHead','MyMFFRoIHead','ESRoIHead'
]
