...
class MaskTestMixin(object):
    ...
    def simple_test_mask(self,
        ...
        # mask_pred = mask_results['edge_pred']
        #mask_pred = mask_results['mask_pred'][0]
        
        # edge_pred = (mask_results['edge_pred'][0][0].sigmoid() >0.5)+0
        # print(edge_pred)
        # edge_pred = mask_results['edge_pred']
        #
        # edge_index = (edge_pred.sigmoid() >0.5) #edge mask
        # mask_pred = (mask_pred + edge_pred)/2
        # mask_pred[edge_index] = (edge_pred[edge_index] + mask_pred[edge_index])/2
